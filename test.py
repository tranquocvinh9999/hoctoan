...
class Ui_Dialog(QtCore.QObject):
    ...
    def show_question(self):
        ...
        self.cauhoi.setAccessibleDescription(question)
    ...
    def ask_chapter(self):
        ...
        self.chapter_menu_dialog.showFullScreen() 
        self.chapter_menu_dialog.setWindowModality(QtCore.Qt.ApplicationModal)
    ...
    # Tạo layout cho các nút chức năng
    ...
    # Tách các thành phần của câu hỏi: số và toán tử
        components = re.findall(r'[\d\-]+|[\+\-\*/]', question)
    ...
    def show_question(self):
        if self.questions:
            question_text = self.questions[0]["question"] 
    ...
    def submit_scores(self):
        ...
        url = f"http://127.0.0.1:5000/scores/" + username
